   ...
   <>
         <div id="conteiner-geral-informacao" className="flex flex-col gap-6">
          ...
          <div id="conteiner-bot-app" className=" flex flex-col sm:flex-row gap-4 mt-2 ">
            ...
            <button id="app-store" className=" flex items-center gap-3 bg-white text-[#F54900] px-6 py-3.5 rounded-xl font-semibold hover:bg-gray-100 hover:scale-105 transition-all duration-300">  
              ...
              <div className="flex flex-col items-start">
                <span className="text-sm font-medium">Download na</span>
                <span className="text-lg font-bold -mt-1">Apple Store</span>
              </div>
            </button>

             <button id="play-store" className=" flex items-center gap-3 bg-black text-white px-6 py-3.5 rounded-xl font-semibold hover:bg-oklch(52.7% 0.154 150.069) hover:scale-105 transition-all duration-300 shadow-lg">  
             <svg xmlns="http://www.w3.org/2000/svg"  width="28" height="28" viewBox="0 0 50 50" fill="currentColor">
              ...
              <div className="flex flex-col items-start">
                <span className="text-sm font-medium">Download na</span>
                <span className="text-lg font-bold -mt-1">Play Store</span>
              </div>
            </button>
